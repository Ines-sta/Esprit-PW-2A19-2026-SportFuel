...
<div class="main-area">
    ...
    <div class="card" style="margin-bottom:20px;">
        <div class="card-header">
            ...
            <div class="detail-head-actions">
                <a href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=edit&id=<?php echo $courseDetail['id_course']; ?>&from=detail" class="btn btn-warning btn-sm">Modifier</a>
                <a href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses" class="btn btn-outline btn-sm">← Retour</a>
            </div>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <form method="POST" action="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=supprimer_article" style="display:inline;" onsubmit="return confirm('Retirer cet article ?');">
    ...
    <form method="GET" action="/Esprit-PW-2A19-2026-SportFuel-main/index.php" class="search-bar" style="margin-bottom:20px;display:flex;gap:12px;align-items:center;flex-wrap:wrap;">
        ...
        <a class="btn btn-outline" href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses">Réinitialiser</a>
    </form>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <a href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=voir&id=<?php echo $c['id_course']; ?>" class="btn btn-success btn-sm">Voir</a>
                                <a href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=edit&id=<?php echo $c['id_course']; ?>&from=list" class="btn btn-warning btn-sm">Modifier</a>
                                <form method="POST" action="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=supprimer" style="display:inline;" onsubmit="return confirm('Supprimer cette liste ?');">
...
<div class="modal-overlay <?php echo (!empty($error) && $action === 'ajouter') ? 'active' : ''; ?>" id="modalAjout">
    <div class="modal">
        ...
        <form method="POST" action="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=ajouter" enctype="multipart/form-data" onsubmit="return validerFormCourse(this)">
            <div class="form-row">
...
<div class="modal-overlay active" id="modalModif">
    <div class="modal">
        ...
        <form method="POST" action="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=modifier" enctype="multipart/form-data" onsubmit="return validerFormCourse(this)">
            ...
            <div class="modal-actions">
                <a href="<?php echo $editSource === 'list'
                    ? '/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses'
                    : '/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=voir&id=' . $courseEdit['id_course']; ?>" class="btn btn-outline">Annuler</a>
...
<div class="modal-overlay" id="modalAjoutArticle">
    <div class="modal">
        ...
        <form method="POST" action="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=ajouter_article" onsubmit="return validerFormArticle(this)">
            <input type="hidden" name="id_course" value="<?php echo $courseDetail['id_course']; ?>">
            <div class="form-row">
                <div class="form-group">
                    <label>Aliment</label>
