...
<head>
    ...
    <link rel="stylesheet" href="/Esprit-PW-2A19-2026-SportFuel-main/public/css/style.css?v=<?php echo urlencode((string)@filemtime(__DIR__ . '/../../public/css/style.css')); ?>">
</head>
<body>
...
<div class="main-content">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo $art['achete'] ? 'checked' : ''; ?>">
                            <td>
                                <a href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=toggle_achete&id_course=<?php echo $courseDetail['id_course']; ?>&id_aliment=<?php echo $art['id_aliment']; ?>">
                            ...
                            <td>
                                <a href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=toggle_achete&id_course=<?php echo $courseDetail['id_course']; ?>&id_aliment=<?php echo $art['id_aliment']; ?>" class="btn btn-outline btn-sm">
    ...
    <!-- Recherche & filtres -->
    <form method="GET" action="/Esprit-PW-2A19-2026-SportFuel-main/index.php" class="search-bar">
        ...
        <?php else: ?>
            ...
            <div class="food-card">
                ...
                <div class="food-card-body">
                    ...
                    <a href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&id=<?php echo $c['id_course']; ?>" class="btn btn-primary btn-sm" style="margin-top:8px;">Consulter</a>
                </div>
            </div>
            <?php endforeach; ?>
        <?php endif; ?>
    ...
    <div class="modal-overlay <?php echo !empty($showOptimizerModal) ? 'active' : ''; ?>" id="optimizerModal">
        <div class="modal" style="max-width:800px;">
            ...
            <form method="POST" action="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=optimiser_preview">
                <div class="form-row">
            ...
            <?php if (!empty($optimizerPreview)): ?>
                ...
                <div class="card optimizer-preview-card">
                    ...
                    <?php if (!empty($optimizerPreview['items'])): ?>
                        <form method="POST" action="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=optimiser_create" class="optimizer-create-form">
