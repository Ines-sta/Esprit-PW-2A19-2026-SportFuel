        ...
        <div class="content-area">
            ...
            <div class="table-section">
                ...
                <div class="assignment-form-wrap">
                    <form method="post" action="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=dashboard" class="assignment-form">
                        ...
                        <?php if (!empty($assignments)): ?>
                            <?php foreach ($assignments as $assignment): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form method="post" action="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=dashboard" onsubmit="return confirm('Supprimer cette assignation ?');">
