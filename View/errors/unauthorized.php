...
if (!$isAuthenticated) {
    $targetPath = '/Esprit-PW-2A19-2026-SportFuel-main/View/auth/connexion.html';
        ...
        <section class="unauthorized-card" aria-labelledby="unauthorizedTitle">
            ...
            <div class="unauthorized-actions">
                ...
                <?php if ($isAuthenticated): ?>
                    <a class="btn btn-secondary" href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=auth&action=logout">Se deconnecter</a>
                <?php endif; ?>
            </div>
        </section>
    </main>
