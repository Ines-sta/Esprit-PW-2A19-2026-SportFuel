...
<aside class="sidebar">
    ...
    <a href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=profil" class="sidebar-profile-chip sidebar-profile-link" style="margin: 2px 16px 10px;" title="Mon profil">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="sidebar-section-label">Outils avancés</div>

        <a href="index.php?page=plans&action=shopping_list" class="sidebar-link <?= ($page === 'plans' && $action === 'shopping_list') ? 'active' : '' ?>">
            <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="10" height="10" rx="1"/><line x1="6" y1="7" x2="10" y2="7"/><line x1="6" y1="10" x2="10" y2="10"/></svg>
            🛒 Liste de courses
        </a>

        <a href="index.php?page=plans&action=ai_generator" class="sidebar-link <?= ($page === 'plans' && $action === 'ai_generator') ? 'active' : '' ?>">
            <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="8" r="6"/><circle cx="8" cy="8" r="2"/></svg>
            🤖 Générateur IA
        </a>

        <a href="index.php?page=plans&action=compare" class="sidebar-link <?= ($page === 'plans' && $action === 'compare') ? 'active' : '' ?>">
            <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="4" width="5" height="8" rx="1"/><rect x="9" y="4" width="5" height="8" rx="1"/></svg>
            ⚖️ Comparer plans
        </a>
        ...
        <a href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=aliments" class="sidebar-link">
            <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="8" r="6"/></svg>
            Aliments
        </a>
        <a href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses" class="sidebar-link">
            <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="10" height="10" rx="1"/></svg>
            Courses
        </a>
        <a href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=training" class="sidebar-link">
        ...
        <a href="/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=coach" class="sidebar-link">
