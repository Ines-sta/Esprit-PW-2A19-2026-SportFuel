<?php
/**
 * BackOffice — Generateur de repas IA
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['generate'])) {
    ...
    if (!function_exists('curl_init')) {
        ...
        // Groq API call (FREE alternative to OpenAI)
        ...
        if ($httpCode === 200 && $response) {
            ...
            // Show error details
            $errorMsg = "❌ Erreur API (Code HTTP: {$httpCode})";
            if ($curlError) {
            ...
            if ($response) {
                ...
                if (isset($errorData['error']['message'])) {
                    $errorMsg .= "\n\nMessage API: " . $errorData['error']['message'];
                } else {
                    $errorMsg .= "\n\nRéponse brute: " . substr($response, 0, 300);
                }
            }
...
<head>
    ...
    <title>Generateur IA — SportFuel Admin</title>
            ...
            <div class="form-page">
                <div class="form-card">
                    <div class="form-card-header">
                        <h3>Generer un repas avec l'IA</h3>
                    </div>
                    <form method="POST">
                        <div class="form-card-body">
                            ...
                            <div class="form-group">
                                <label for="plan_type">Type de regime</label>
