-- ============================================
-- Script de mise à jour : Ajout des ingrédients aux repas
-- Projet : SportFuel
-- Date : 2026-05-12
-- ============================================
...
-- Ajouter la colonne ingredients si elle n'existe pas
ALTER TABLE Repas 
ADD COLUMN IF NOT EXISTS ingredients TEXT DEFAULT NULL 
AFTER description;

-- Afficher un message de confirmation
SELECT 'Colonne ingredients ajoutée avec succès à la table Repas' AS Message;

-- Optionnel : Ajouter des exemples d'ingrédients pour les repas existants
