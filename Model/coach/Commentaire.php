...
class Commentaire {
    ...
    public function addCommentaire($id_pub, $text, $id_utilisateur = null) {
        $stmt = $this->pdo->prepare("INSERT INTO commentaire (id_pub, id_utilisateur, text, date) VALUES (?, ?, ?, NOW())");
        return $stmt->execute([$id_pub, $id_utilisateur, $text]);
    }
