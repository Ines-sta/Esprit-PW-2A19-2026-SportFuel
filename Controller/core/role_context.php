...
function sportfuel_canonical_redirect_path($role) {
    if (strcasecmp((string)$role, 'Admin') === 0 || strcasecmp((string)$role, 'Coach') === 0) {
        return '/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=dashboard';
    }
    return '/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=home';
}

function sportfuel_legacy_redirect_path($role) {
    if (strcasecmp((string)$role, 'Admin') === 0 || strcasecmp((string)$role, 'Coach') === 0) {
        return '/Esprit-PW-2A19-2026-SportFuel-main/index.php?page=back&action=listPlans';
    }
    return '/Esprit-PW-2A19-2026-SportFuel-main/View/users/profil.html';
}
