    ...
    case 'toggle_achete':
        ...
        if ($id_course > 0 && $id_aliment > 0) {
            ...
            if ($course && (int)$course['id_utilisateur'] === $currentUserId) {
                ...
                header('Location: /Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&id=' . $id_course . '&success=achat');
                exit;
            }
        }
        break;
            ...
            elseif ($optimizerInput['budget_max'] <= 0) $error = 'Le budget max doit être un nombre positif.';
                ...
                try {
                    ...
                    if (empty($optimizerPreview['items'])) {
                        ...
                        if ($newCourseId > 0) {
                            header('Location: /Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&id=' . $newCourseId . '&success=optimise');
                            exit;
                        }
