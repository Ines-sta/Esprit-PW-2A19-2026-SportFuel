...
switch ($action) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            elseif (!in_array($statut, $statutsAutorises, true)) $error = 'Statut invalide.';
                ...
                if ($uploadErr !== '') {
                    ...
                    header('Location: /Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&success=ajout');
                    exit;
                }
            }
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            elseif (!in_array($statut, $statutsAutorises, true)) $error = 'Statut invalide.';
                ...
                if ($uploadErr !== '') {
                    ...
                    if ($editSource === 'list') {
                        header('Location: /Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&success=modif');
                    } else {
                        header('Location: /Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=voir&id=' . $id . '&success=modif');
                    }
                    exit;
                }
            }
    ...
    case 'supprimer':
        ...
        if ($id > 0 && isCourseAllowed($courseModel, $id, $allowedUserIds)) {
            ...
            header('Location: /Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&success=suppr');
            exit;
        } elseif ($id > 0) {
    ...
    case 'ajouter_article':
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            elseif (!in_array($unite, $unitesAutorisees, true)) $error = 'Unité invalide.';
                ...
                header('Location: /Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=voir&id=' . $id_course . '&success=article_ajout');
                exit;
            }
        }
        break;
    ...
    case 'supprimer_article':
        ...
        if ($id_course > 0 && $id_aliment > 0 && isCourseAllowed($courseModel, $id_course, $allowedUserIds)) {
            ...
            header('Location: /Esprit-PW-2A19-2026-SportFuel-main/index.php?page=courses&action=voir&id=' . $id_course . '&success=article_suppr');
            exit;
