...
switch ($action) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            elseif ($prix_unitaire <= 0) $error = "Le prix unitaire doit être un nombre positif.";
                ...
                if ($uploadErr !== '') {
                    ...
                    header('Location: /Esprit-PW-2A19-2026-SportFuel-main/index.php?page=aliments&success=ajout');
                    exit;
                }
            }
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            elseif ($prix_unitaire <= 0) $error = 'Le prix unitaire doit être un nombre positif.';
                ...
                if ($uploadErr !== '') {
                    ...
                    header('Location: /Esprit-PW-2A19-2026-SportFuel-main/index.php?page=aliments&success=modif');
                    exit;
                }
            }
        }
    ...
    case 'supprimer':
        ...
        if ($id > 0) {
            ...
            header('Location: /Esprit-PW-2A19-2026-SportFuel-main/index.php?page=aliments&success=suppr');
            exit;
        }
        break;
}
