...
function redirectUnauthorized($message = 'Acces refuse.') {
    ...
    header('Location: /Esprit-PW-2A19-2026-SportFuel-main/index.php?page=unauthorized');
    exit;
}
...
if ($page === 'home') {
    ...
    if ($action === 'shopping_list') {
        requireAuthenticatedUser();
        include 'View/plans/shopping_list.php';
    } elseif ($action === 'ai_generator') {
        requireBackofficeRole();
        include 'View/plans/ai_meal_generator.php';
    } elseif ($action === 'compare') {
        requireAuthenticatedUser();
        include 'View/plans/compare_plans.php';
    } else {
        requireSportifRole();
